                    ...
                    <div class="product_slider_img">
                        <div id="vertical">
                            <div data-thumb="img/product/single-product/product_1.png">
                                <img src={{ asset('storage/' . $products->src) }} />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 col-xl-4">
                    <form action="/updateProducts/{{ $products->id }}" method="POST" class="s_product_text">
                        @csrf
                        <h3>{{ $products->name }}</h3>
                        <h2>{{ $products->prix }}€</h2>
                        <ul class="list">
                            <li>
                                <a class="active" href="#">
                                    <span>Category</span> : {{ $products->categoris->name }}</a>
                            </li>
                            <li>
                                <a href="#"> <span>Availibility</span> : {{ $products->quantite }}</a>
                            </li>
                        </ul>
                        <p>
                        ...
                        @auth
                            <div class="card_area d-flex justify-content-between align-items-center">
                                <div class="product_count">
                                    ...
                                    <input class="input-number" name="quantite" type="text" value="{{ $products->quantite }}">
                                    <span class="number-increment"> <i class="ti-plus"></i></span>
                                </div>
                                <button type="submit" class="btn_3">édit</button>
                            </div>
                        @endauth
                    </form>
                </div>
